function verifyCallback(response) {
  document.querySelector('#g-recaptcha').dataset.valid = 'true';
}

function verifyCallback2(response) {
  document.querySelector('#g-recaptcha2').dataset.valid = 'true';
}

// function onRecaptchaLoadCallback() {

//   grecaptcha.render('g-recaptcha', {
//     'sitekey': '6LdkpX4qAAAAABDQx5OuUltaT6g5elYSBlxKDujq',
...
function onRecaptchaLoadCallback() {
  document.querySelectorAll('[data-popup="apply-form"]').forEach(el => {

    el.addEventListener('click', function () {

      if (!document.querySelector('#g-recaptcha').dataset.rendered) {
        grecaptcha.render('g-recaptcha', {
          'sitekey': '6LdkpX4qAAAAABDQx5OuUltaT6g5elYSBlxKDujq',
          'callback': verifyCallback,
        });

        document.querySelector('#g-recaptcha').dataset.rendered = 'true';
      }
    });
  })

  if (document.getElementById('formContacts')) {
    grecaptcha.render('g-recaptcha-2', {
      'sitekey': '6LdkpX4qAAAAABDQx5OuUltaT6g5elYSBlxKDujq',
      'callback': verifyCallback2,
    });
